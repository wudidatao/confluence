...
#ADD crack/mysql-connector-java-5.1.47.jar ${CONFLUENCE_INSTALL_DIR}/confluence/WEB-INF/lib/
...
#RUN chown -R ${RUN_USER}:${RUN_GROUP} ${CONFLUENCE_INSTALL_DIR}/confluence/WEB-INF/lib/mysql-connector-java-5.1.47.jar
